...
public class Cwiczenie_J49 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Podaj napis (end - wyjœcie):");
		
		String znaki = input.nextLine();
		
		ArrayList<String> lista = new ArrayList<String>();
		
		while ((!znaki.equals("end")) && (!znaki.equals("END"))){ // UWAGA!!! do porównania dwóch stringów u¿ywamy "equals" w tym wypadku jest zaprzeczenie
