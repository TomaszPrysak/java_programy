...
public class Cwiczenie_J50_J51 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Podaj produkt spoœród dostêpnych " + sklep.keySet() + " (koniec - wyjscie i rachunek:");
...
//			}
//			
//			System.out.println("Podaj nastêpny produkt:");
...
//		input.close();
		...
		while (!produkt.equals("koniec")){
			if (!koszyk.contains(produkt)){
				...
				System.out.println("W koszytku juz siê znajduje taki sam produkt. Czy chcesz dodaæ drug¹ sztukê (T)ak, (N)ie");
				String decyzja = "";
