...
public class Cwiczenie_J91 {
	...
	public static void main(String[] args) {
		...
		while(error){
			System.out.println("Podaj ca³kowit¹ (lub q - wyjœcie):");
			...
			error = false;
				...
				System.out.println("Wprowadzona wartoœæ nie jest liczb¹ lub nie jest liczb¹ ca³kowit¹. Wprowadz liczbê ca³kowit¹");
