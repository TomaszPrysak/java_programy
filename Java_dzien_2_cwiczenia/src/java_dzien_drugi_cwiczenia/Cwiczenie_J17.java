...
public class Cwiczenie_J17 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Dzielenie du¿ych liczb: " + bigIntDzielenie.toString()); // wyœwietli³o zero bo dzielimy mniejsz¹ przez wiêksz¹ i na dodatek zdeklarowaliœmy t¹ zmienn¹ jako integer a nie zmiennoprzecinkow¹ 
		...
		// System.out.println("Dzielenie du¿ych liczb zmiennoprzecinkowych: " + bigDecDzielenie.toString()); // tutaj zawróci b³¹d bo jest du¿a reprezentacja liczb w okresie np X.33333333333....
		
		System.out.println(bigDecDzielenie); // tutaj nie zwróci b³edu poniewa¿ wynik dzielenia nie ma liczby z okresem który jest satle powiêkszany np. X.666666666666....
