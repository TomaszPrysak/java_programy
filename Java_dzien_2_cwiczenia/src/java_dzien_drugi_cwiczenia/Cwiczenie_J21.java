...
public class Cwiczenie_J21 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Program porównuj¹cy dwie podane liczby");
		...
		System.out.println("Czy liczba a jest wiêksza od b: " + (a > b));
		System.out.println("Czy liczba a jest mniejsza od b: " + (a < b));
		System.out.println("Czy liczba a jest równa b: " + (a == b));
		System.out.println("Czy liczba a jest ró¿na od b: " + (a != b));
