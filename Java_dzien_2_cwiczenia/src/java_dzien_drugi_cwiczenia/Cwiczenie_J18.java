...
public class Cwiczenie_J18 {
	...
	public static void main(String[] args) {
		...
		System.out.println(x + " podniesione do potêgi: " + y +  " wynosi: " + potega);
		System.out.println("Wartosc bezwzgledna z " + y + " to: " + bezwzgledna);
		
		System.out.println("Obwód okregu o œrednicy " + r + " wynosi: " + obwod);
		System.out.println("Pole kola o œrednicy " + r + " wynosi: " + pole);
		
		System.out.printf("Value: %.2f", obwod); // sposób na zaaokr¹glenie
