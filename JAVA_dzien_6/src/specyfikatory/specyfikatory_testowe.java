...
public class specyfikatory_testowe {
	...
	public static void main(String[] args) {
		...
		gs1.setA(15); // w ten sposób zmieniamy wartoœæ zmiennej za pomoc¹ Setters, nie mo¿emy tak  gs1.t = "test"; // nie jest widoczne pole t klasy GetSet poniewa¿ wprowadzilismy Gettery i Settery a nasze pola s¹ privatem czyli s¹ widoczne tylko w swojej klasie  
		System.out.println(gs1.getA());
