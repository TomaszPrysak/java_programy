...
public class LoginController {
    ...
    void loginAction(MouseEvent event) throws IOException {
    	...
    	if((tf_login.getText().equals("admin") && pf_pass.getText().equals("admin")) || (tf_login.getText().equals("admin") && tf_pass.getText().equals("admin"))){
    		...
    		// w celu wyœweitlenia kolejnej sceny "po zalogowaniu" u¿ywamy takiej samej konstrukcji jak w klasie Main u¿ywaliœmy do wystartowania programu poprzez wyœwietlenie g³ównego okna logowania
