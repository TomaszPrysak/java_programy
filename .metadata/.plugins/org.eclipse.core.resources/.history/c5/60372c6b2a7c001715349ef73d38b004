...
//		int[][] mJ2 = new int [3][3]; // mJ2 = macierz jednostkowa druga // nie potrzebna nam druga macierz bo mo¿emy dodaæ pierwsz¹ macierz do samej siebie
		int[][] mS = new int [3][3]; // mS = macierz sumy dwóch macierzy jednostkowych
