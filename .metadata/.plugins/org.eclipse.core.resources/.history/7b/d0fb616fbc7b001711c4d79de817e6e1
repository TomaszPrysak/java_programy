...
public class Operacje_na_zmiennych {
	...
	public static void main(String[] args) {
		...
		c = a/b; // poniewa¿ wynik z dzielenia jest liczb¹ zmiennoprzecikow¹ a je¿eli zmienna bêdzie integer wiec wynik z dzielenia nie poka¿e nam to co jest po przecinku tylko zaookr¹gli w dó³
		...
		System.out.println(letter1+letter2+letter3); // b³êdne sumowanie poniewa¿ w tym momencie zmianiena znaki na integer czyli ich po³o¿enie w tabeli ascii
		...
		int number2 = 5;
		int zawezanie = (int)number1; // zamieniamy liczbê zmiennoprzecinkow¹ na sta³oprzecinkow¹
		double poszerzenie = (double)number2; // zamieniamy liczbê sta³oprzecinkow¹ na zmiennoprzecinkow¹
		System.out.println("Rzutowanie: " + zawezanie); // wyœwietlamy liczbê sta³oprzecinkow¹ po zamianie ze zmiennoprzecinkowej i obcina czêœci dziesêtne
		System.out.println("Poszerzenie: " + poszerzenie); // wyœweitlamy liczbê zmienno przecinkow¹ ze sta³oprzecinkowej i dorzucenie czêœci dziesiêtnych
		*/
		
		// Uwaga !!! przy porownaniu obiektów pos³ugujemy siê porównaniem "==" a przyporównywaniu 1:1 u¿ywamy "equals"
