...
public class Lokalizacja_Local {
	...
	public static void main(String[] args) {
		...
		double a = input.nextDouble(); // nextDouble zczytuje dane do pustego znaku, a w naszym przypadku pustym znakiem jest enter wywo³any poprzez naciœniecie po wstawieniu liczby
