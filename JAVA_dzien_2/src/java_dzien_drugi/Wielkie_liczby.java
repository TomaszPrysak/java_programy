...
public class Wielkie_liczby {
	...
	public static void main(String[] args) {
		...
		// liczby typu Big równie¿ wymagaj¹ zaimportowania biblioteki Math
		...
		BigInteger bigIntX = BigInteger.valueOf(x); // jest to metoda statyczna która konwertuje nasz¹ liczbê typu long na liczbê Big po to aby pózniej mozna bylo robic jakies opercje na wielkich liczbach
