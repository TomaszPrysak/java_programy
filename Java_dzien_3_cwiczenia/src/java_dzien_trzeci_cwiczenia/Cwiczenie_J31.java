...
public class Cwiczenie_J31 {
	...
	public static void main(String[] args) {
		...
		char A = wyraz2.charAt(wyraz2.length() - 3); // zdeklarowanie zmiennej A typu chart (znak) i inicjalizowanie do niej 3 litery od koñca z wyrazu 2
		
		String separator = String.valueOf(A); // poniewa¿ ka¿da zaminna (i nie tylko zmienna, tablica te¿ itd) w javie jest innym typem to musimy przekszta³caæ z jednego typu zmiennej 
