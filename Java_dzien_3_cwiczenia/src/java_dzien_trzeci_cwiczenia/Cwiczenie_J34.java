...
public class Cwiczenie_J34 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Podaj I liczbê:");
		
		int liczba1 = input.nextInt();
		
		System.out.println("Podaj II liczbê która jest wiêksza od I liczby :");

		int liczba2 = input.nextInt();
		
		while(liczba2 < liczba1){
			System.out.println("Podana liczba nie jest wiêksza od I liczby:");
			System.out.println("Podaj II liczbê ca³kowit¹:");
