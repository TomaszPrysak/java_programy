...
//		lista1.set(1, "Ola"); // je¿eli chcemy zmodyfikowaæ indeks który nie istnieje to wyrzuca nam b³¹d
		...
		System.out.println(mapa); // wyœwietlenie zawartoœci mapy wraz z przypisanymi kluizcami i wartoœciami
		...
		mapa.clear(); // czyœci zawartosæ mapy
		System.out.println(mapa);
		
		// 4. Kolejki / Stosy
		// Aby stosowaæ kolejki musimy zaimportowaæ bibliotekê kolejki.
		// Dzia³aj¹ one na zasadzie, ¿e mo¿emy dodawaæ do niej wartoœci na pocz¹tku lub na koñcu, pobieraæ zawartoœæ z pocz¹tku z jednoczesnym usuwaniem ze stosu albo zostawianiem jej w stosie
		...
		stos.addFirst("napis pocz¹tkowy"); // najwiêksza u¿ytecznoœæ sotsu to mo¿liwoœæ dodawania na pocz¹tku stosu jakiejœ wartoœci...
		stos.addLast("napis koñcowy"); // albo na koñcu
		System.out.println(stos);
		
		String a = stos.pollFirst(); // zdjêcie ze stosu i przypisanie do zmiennej oraz usuniêcie ze stosu  wartoœci w stosie znajduj¹cej siê na pierwszym miejscu
//		String b = stos.pollLast();
		System.out.println(a);
		System.out.println(stos);
		
		String c = stos.getLast(); // zdjêcie ze stosu i przypisanie do zmiennej oraz pozostawienie w stosie wartoœci znajeuj¹cej siê na ostatnim miejscu
//		String d = stos.getFirst();
		System.out.println(c);
		System.out.println(stos);
		
		stos.remove("napis2"); // usuwa konkretn¹ wartoœæ w stosie
		System.out.println(stos);
		System.out.println(stos.size()); // zwraca wielkoœæ stosu
